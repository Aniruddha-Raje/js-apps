...
let fsRename = async() => {
  ...
  for(let tmp in readDirResult){
      ...
      await fsRename('./temp/'+file,'/Users/aniruddhanarendraraje/Documents/work/pocs/node-crud-app/snippets/temp/testdasd_'+random_uuid+suffix);
  }
}
...
let copyFile = async() => {
  ...
  try {
    ...
    await fsCopyFile('/Users/aniruddhanarendraraje/Documents/work/pocs/node-crud-app/snippets/sharp/enhancedTest.jpg','/Users/aniruddhanarendraraje/Documents/work/pocs/node-crud-app/snippets/sharp2/enhancedTest.jpg');
...
let fsMkdir = async() => {
  ...
  try {
    ...
    await fsMkdir('/Users/aniruddhanarendraraje/Documents/work/pocs/node-crud-app/snippets/sharp3');
...
let isDirPresent = async() => {
  ...
  try {
    ...
    let dirPath = "/Users/aniruddhanarendraraje/Documents/work/pocs/node-crud-app/snippets/sharp";
